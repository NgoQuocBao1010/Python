...
while run:
    ...
    if p1.hitbox[1] < monster.hitbox[1] + monster.hitbox[3] and p1.hitbox[1] + p1.hitbox[3] > monster.hitbox[1]:
        if p1.hitbox[0] + p1.hitbox[2] > monster.hitbox[0] and p1.hitbox[0] < monster.hitbox[0] + monster.hitbox[2]:
            p1.gethit()
            score -= 50
